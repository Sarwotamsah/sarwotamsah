...
### Developer • Innovator • Tech Enthusiast • Builder of the Future
...
Hey there! I’m **Sarwotam Sah**, an aspiring Computer Engineering student, a passionate Developer, and a creative Tech Innovator driven by the mission to build meaningful digital solutions. **With over 2 years of experience as a WordPress developer and hands-on skills in modern web technologies**, I specialize in building clean, functional, and high-impact digital experiences. 



### 💡 What I Do

- 🌐 **Full Stack Development** — Crafting seamless web experiences from frontend to backend
- 🤖 **IoT & Robotics** — Building intelligent automation systems
- 🏙️ **Smart City Solutions** — Designing digital ecosystems for better communities
- 🎨 **UI/UX Design** — Creating intuitive, futuristic interfaces
- 🔧 **Problem Solving** — Turning complex challenges into elegant solutions

> **Mission:** *"I engineer technology that brings people together, simplifies life, and inspires the next generation of innovators."*
...
|:--------------|:---------|:-----------|
| **1st Place** | Smart City Project @ KIST College | IoT-based automation, traffic control & smart resource management [[Link]](https://youtu.be/-DrGsDnIoX0?si=S_IPiejZYk0m5Vhn) |
| **3rd Place** | Digitalized Community @ Ripumardini Sainik School | Digital transformation for safer, smarter communities |
| **Founder** | SewaLink Platform | Smart employment & community service ecosystem [*Under Development*]|
...
### 🌟 SewaLink — Digital Community Ecosystem

*A revolutionary platform connecting professionals with citizens efficiently*

**Impact:** Empowering communities across Nepal with smart employment solutions
...
- 🚀 Launching Soon **SewaLink** platform in Nepal
...
### ✨ "I'm not here to follow the future. I'm here to build it." ✨

**If you like my work, ⭐ my repositories!**  
**Let's collaborate and create something extraordinary together.**

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=150&section=footer&text=Thank%20You%20for%20Visiting!&fontSize=40&fontColor=fff&animation=twinkling&fontAlignY=75" width="100%" />
